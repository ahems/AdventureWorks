...
- `SpecialOffer.csv` – Special offers and promotions (one row per offer per culture; generated by `scripts/generators/generate-special-offer-translations.sh` with translated descriptions for all cultures).
