          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            {isAuthenticated && (
              <nav className="hidden md:flex items-center gap-5">
                ...
                <Link
                  to="/reports"
                  className={`font-doodle text-doodle-text hover:text-doodle-accent transition-colors flex items-center gap-1 ${location.pathname.startsWith("/reports") ? "squiggle" : ""}`}
                >
