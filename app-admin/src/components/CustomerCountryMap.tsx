...
const CustomerCountryMap: React.FC<CustomerCountryMapProps> = ({ customers }) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="relative bg-doodle-accent/5 border-2 border-doodle-text/20 rounded-lg p-4 min-h-[300px]">
            ...
            >
              ...
              <ellipse cx="20" cy="42" rx="15" ry="20" fill="currentColor" className="text-doodle-text" />
              <ellipse cx="30" cy="72" rx="10" ry="18" fill="currentColor" className="text-doodle-text" />
              <ellipse cx="52" cy="38" rx="12" ry="15" fill="currentColor" className="text-doodle-text" />
              <ellipse cx="58" cy="68" rx="8" ry="12" fill="currentColor" className="text-doodle-text" />
              <ellipse cx="75" cy="48" rx="15" ry="18" fill="currentColor" className="text-doodle-text" />
              <ellipse cx="85" cy="78" rx="8" ry="6" fill="currentColor" className="text-doodle-text" />
            </svg>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{ width: `${size}px`, height: `${size}px`, fontSize: `${Math.max(10, size * 0.4)}px` }}
                  >
                    {stat.count}
                  </div>
                  ...
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-10">
                    <div className="bg-doodle-text text-white px-3 py-2 rounded-lg shadow-lg whitespace-nowrap">
                      ...
                      <div className="font-doodle text-xs mt-1">
                        {stat.count} customer{stat.count !== 1 ? 's' : ''} • ${stat.totalSpent.toFixed(0)}
                      </div>
                    </div>
          ...
          <div className="space-y-3">
            ...
            {countryStats.map((stat, index) => (
              <div key={stat.country} className="flex items-center gap-3">
                <span className="font-doodle text-doodle-text/50 w-6 text-right">{index + 1}.</span>
